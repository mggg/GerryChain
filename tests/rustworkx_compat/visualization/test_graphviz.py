...
from gerrychain.rustworkx.visualization import graphviz_draw
...
class TestGraphvizDraw(unittest.TestCase):
    ...
    @unittest.skip(
        "GerryChain: crashes on machines with a broken graphviz sfdp binary (input-dependent "
        "SIGABRT/SIGSEGV); fails identically through upstream rustworkx wheels. See UPSTREAM.md."
    )
