...
def within_percent_of_ideal_population(
    ...
    Args:
        ...
        pop_key (str, optional): The name of the population :class:`Tally
            <gerrychain.updaters.Tally>`. Default is ``"population"``.

    Returns:
        Bounds: A :class:`.Bounds` constraint on the population attribute identified by ``pop_key``.
    """
...
def deviation_from_ideal(partition: Partition, attribute: str = "population") -> Dict[int, float]:
    ...
    Args:
        ...
        attribute (str, optional): The :class:`Tally <gerrychain.updaters.Tally>` to compute
