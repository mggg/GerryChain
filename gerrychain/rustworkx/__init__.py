...
# flake8: noqa
import gerrychain.rustworkx.visit

__rustworkx_mod__ = importlib.import_module(".rustworkx", package="gerrychain.rustworkx")
sys.modules["gerrychain.rustworkx.generators"] = __rustworkx_mod__.generators
