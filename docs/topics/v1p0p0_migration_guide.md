...
This guide will help you understand what you need to change in your "legacy" GerryChain code so
that it can run in the v1.0.0 release.
...
In NetworkX an edge is a tuple of node*ids and an edge_id is the \*\*\_same*\*\* tuple of node_ids,
...
These are properties, not methods, so access them without parentheses:
