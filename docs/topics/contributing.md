...
the {doc}`installation </user/install>` section of the documentation. However, rather
...
more information, see the [PEP 8 Style Guide](https://www.python.org/dev/peps/pep-0008/).
