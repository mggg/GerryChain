...
use crate::rustworkx::iterators::NodeMap;
...
use crate::rustworkx::RxPyResult;
use petgraph::algo;
...
///     only a potential performance optimization if the complete size of the graph is known in
///     advance.
#[pyclass(mapping, module = "gerrychain.rustworkx", subclass, from_py_object)]
#[derive(Clone)]
pub struct PyGraph {
...
impl PyGraph {
    ...
    /// :rtype: PyDiGraph
    #[pyo3(text_signature = "(self)")]
    pub fn to_directed(&self, py: Python) -> crate::rustworkx::digraph::PyDiGraph {
        ...
        crate::rustworkx::digraph::PyDiGraph {
            graph: new_graph,
            node_removed: false,
