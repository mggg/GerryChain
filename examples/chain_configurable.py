from rundmcmc.validity import Validator, no_vanishing_districts, refuse_new_splits, single_flip_contiguous
...
chain = MarkovChain(propose_random_flip, validator, always_accept, initial_partition, total_steps=steps)
